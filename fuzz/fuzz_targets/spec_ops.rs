...
//!
//! The input bytes pick a scalar/float spec row (`temen_spec::all_rows`) and feed it random
...
//! the spec definition. Driver + stable mirror: `crates/temen/tests/support/specfuzz.rs`.
//!
...
#[path = "../../crates/temen/tests/support/specfuzz.rs"]
mod specfuzz;
