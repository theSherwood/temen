// CodeMirror 5.65.16 — vendored bundle for the Temen playground editor (UI only; never
// touches the sandbox or any authority). Generated by build-codemirror-bundle.sh from the
// pinned upstream files at https://cdn.jsdelivr.net/npm/codemirror@5.65.16/. A single top-level file so the Pages assemble step
// (which copies only web/*.js) deploys it; it also injects CodeMirror's own CSS. CodeMirror
// is released under the MIT License, Copyright (C) 2017 by Marijn Haverbeke and others.
//
