...
if (typeof window === 'undefined') {
    ...
    (() => {
        ...
        // If we're already coi: do nothing. Perhaps it's due to this script doing its job, or COOP/COEP
        // are already set from the server. Also if the browser has no notion of crossOriginIsolated, do
        // nothing (it's likely because we're serving over http, not https).
