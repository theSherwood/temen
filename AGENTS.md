...
**Don't create background subscriptions or scheduled check-ins unless asked.** A PR-activity
subscription, a recurring Routine, or a self-scheduled wake-up costs the owner credits *every time
it fires* — an hourly "nothing changed" poll can burn a night's budget and tell nobody anything.
Report status when you finish the work and let the owner come back to you. Set one up only when the
owner asks for it in so many words, and tear it down as soon as the thing it watches merges, closes,
