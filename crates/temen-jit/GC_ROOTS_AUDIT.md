...
**1. Parked fibers and running ancestors are sound.** The fiber switch (`temen-fiber`'s `jump`) pushes
...
Route `gc.roots` through a **register-flush trampoline** (`fiber_rt::temen_gc_roots_flush`, one
