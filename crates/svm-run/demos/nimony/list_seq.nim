...
# backend, on-ramped to SVM (build_nim.sh). This is genuine Nim-compiler codegen — ref
...
#
# Deterministic stdout + exit code so the SVM run diffs byte-for-byte against a native build.
