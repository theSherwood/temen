 ...
 *     (`crates/svm-run/src/fs.rs`), op selected by arg0, the host binds it to a seeded memfs. This is
 ...
 * calls). The op protocol constants mirror `crates/svm-run/src/fs.rs`. */
