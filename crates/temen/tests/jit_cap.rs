...
//! data/concurrency rejection — is the **shared** [`temen_run::jit_blob_validator`], installed
//! identically on both backends by [`temen_run::grant_jit`], so accept/reject is identical by
...
const BLOB_OFF: usize = 20480; // #1094: one NULL guard (16384) above the legacy 4096 scratch
...
/// The unit `atomic.wait`s on `mem[16448]` with an expected value that does **not** match (0 ≠ 99), so
...
fn installed_unit_futex_wait_native_agrees() {
    // The unit's `f0() -> i32` `atomic.wait`s on mem[16448] (=0) expecting 99 → returns 1 (not-equal).
...
fn compile_and_invoke_agree_across_backends() {
    ...
    assert_eq!(mem[16448], 0xab, "invoked code writes the live window");
}
...
fn garbage_blob_rejected_identically() {
    let garbage = b"not an temen module at all".to_vec();
...
fn invoked_unit_calls_installed_unit_agrees() {
    ...
    // Lay A at BLOB_OFF (20480), B right after it.
...
fn two_units_interleaved_agree_across_backends() {
    ...
    // Both blobs in memory: add at BLOB_OFF (20480), mul right after it.
...
/// lands at slot 2 of the reserved table). Window (#1094 guard-shifted): `[16384]` ready flag,
/// `[16388]` slot index, `[16392]` result.
///
...
fn threaded_install_agrees_across_backends() {
    ...
    let guest_src = concat!(
        ...
        "  v8 = i32.wrap_i64 v7\n",
        "  v9 = i64.const 16388\n",
        "  i32.store v9 v8\n", // window[16388] = slot (#1094: guard-shifted from 4)
        "  v10 = i64.const 16384\n",
        "  v11 = i32.const 1\n",
        "  i32.atomic.store v10 v11\n", // window[16384] = ready (release) (#1094: guard-shifted from 0)
        "  v12 = thread.join v6\n",     // worker result (i64)
        ...
        "block 1 () {\n",
        "  v2 = i64.const 16384\n",
        "  v3 = i32.atomic.load v2\n", // ready? (acquire) (#1094: guard-shifted from 0)
        "  v4 = i32.const 0\n",
        "  v5 = i32.ne v3 v4\n",
        "  br_if v5 2() 1()\n", // spin until ready
        "  }\n",
        "block 2 () {\n",
        "  v6 = i64.const 16388\n",
        "  v7 = i32.load v6\n", // slot (visible via the acquire) (#1094: guard-shifted from 4)
        "  v8 = i32.const 6\n",
        "  v9 = i32.const 7\n",
...
fn threaded_compile_loop_stress_agrees() {
    ...
    let guest_src = concat!(
        ...
        "  br 1(v0, v3, v4, v4)\n", // jit, wh, i, acc
        "  }\n",
        "block 1 (v5: i32, v6: i32, v7: i32, v8: i32) {\n",
        "  v9 = i32.const 10\n",
        "  v10 = i32.lt_u v7 v9\n",
        "  br_if v10 2(v5, v6, v7, v8) 3(v6, v8)\n",
        "  }\n",
        ...
        "  v21 = i32.const 1\n",
        "  v22 = i32.add v13 v21\n",
        "  br 1(v11, v12, v22, v20)\n",
        "  }\n",
        "block 3 (v23: i32, v24: i32) {\n", // wh, acc
        "  v25 = thread.join v23\n",
        ...
        "  br 1(v2, v3, v3)\n", // jit, i, acc
        "  }\n",
        "block 1 (v4: i32, v5: i32, v6: i32) {\n",
        "  v7 = i32.const 10\n",
        "  v8 = i32.lt_u v5 v7\n",
        "  br_if v8 2(v4, v5, v6) 3(v6)\n",
        "  }\n",
...
fn cross_thread_execute_fresh_code_agrees() {
    ...
    let guest_src = concat!(
        ...
        "  v10 = i64.const 16384\n",
        "  v11 = i32.const 1\n",
        "  i32.atomic.store v10 v11\n", // publish ready (release) (#1094: window[16384/16388])
        "  v12 = thread.join v3\n",
        "  v13 = i32.wrap_i64 v12\n",
        "  return v13\n",
        "  }\n",
        ...
        "block 1 () {\n",
        "  v2 = i64.const 16384\n",
        "  v3 = i32.atomic.load v2\n", // ready? (acquire) (#1094: window[16384])
        "  v4 = i32.const 0\n",
        "  v5 = i32.ne v3 v4\n",
        "  br_if v5 2() 1()\n",
        "  }\n",
...
// drain-once semantics, and the final window bytes. The routing veto is pinned too:
// `bytecode::serve_qualifies` admits the pure serving module (pre-slice, `svc.poll` answered
// `-EINVAL` here and the fold hid it) and rejects the park-seam module (which keeps folding).
// ---------------------------------------------------------------------------

/// The serving domain from the §3.6 corpus (as `temen-interp/tests/bytecode_svc.rs`): offer
...
fn svc_module(src: &str) -> Arc<temen_ir::Module> {
...
/// function nothing calls) fails the qualification, so temen-run keeps folding it to the oracle —
...
fn a_park_seam_fails_the_serve_qualification() {
    let m = svc_module(SERVER_WITH_PARK_SEAM);
    assert!(
        !bytecode::serve_qualifies(&m.funcs),
