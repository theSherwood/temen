...
//!
//! temen provides **no** world-stop primitive — STW is pure guest code over the existing window
...
//! (e.g. JACL) has a tested pattern to copy. temen wraps only the collector↔vCPU rendezvous; the
...
fn run_interp_pair(m: &temen_ir::Module) -> (i64, i64) {
...
fn run_jit_pair(m: &temen_ir::Module) -> (i64, i64) {
