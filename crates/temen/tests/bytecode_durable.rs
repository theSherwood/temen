...
//!
//! Durable freeze/thaw is **IR-driven** (DURABILITY.md §2): the `temen-durable` transform rewrites a
...
//!
//! This checks the bytecode engine against the tree-walker oracle and the `temen-snapshot` §12 codec:
