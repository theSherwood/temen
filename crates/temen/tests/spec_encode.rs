...
//! so an `temen-encode` renumbering or family-base move is a red test, not a silent
//! format break.
//!
...
use temen_spec::{all_rows, mem_rows, module_for, module_for_mem, vectors_for, Enc, Shape};
