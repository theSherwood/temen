...
//! reference) and the JIT. The §12 concurrency work grew the escape-TCB — a shared `temen-mem`
...
//!
//! Gated to the targets where the JIT runs threads (`temen_fiber::supported()`); the interpreter runs
