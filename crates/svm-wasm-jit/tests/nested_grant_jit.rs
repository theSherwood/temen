...
use svm_interp::{bytecode, ForkedProc, Host, HostProc, Region, Value};
use svm_wasm_jit::compile_module_reactor;
...
fn oracle(m: &svm_ir::Module, arg: i64) -> (i64, i64) {
...
fn jit_run(m: &svm_ir::Module, arg: i64) -> (i64, i64) {
