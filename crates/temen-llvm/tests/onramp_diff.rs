...
//! **three** temen backends (tree-walker, bytecode, JIT) return the generator's **oracle** value.
//!
...
//!
//! Run more iterations locally: `TEMEN_ONRAMP_DIFF_ITERS=200000 cargo test -p temen-llvm onramp_diff`.
...
fn onramp_backends_agree_with_source_oracle() {
    let iters: u64 = std::env::var("TEMEN_ONRAMP_DIFF_ITERS")
        .ok()
