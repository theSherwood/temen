...
//!    captured once (via `temen_interp::Inspector`: breakpoint at `luaV_execute` entry, read the window
...
//!
//! Run: `cargo test -p temen-llvm --test lua_futamura_feasibility -- --nocapture`
