...
//! takes the float fast path. The [`temen_peval::PoscallModel::selective`] entry pins the result slot's
...
//! the interpreter.
//!
//! Run: `cargo test -p temen-llvm --test lua_futamura_call_float -- --nocapture`
