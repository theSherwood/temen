...
//! [`temen_peval::PretailcallModel`] mirrors the precall model for this shape: at a matching `ra` the
...
//!
//! Run: `cargo test -p temen-llvm --test lua_futamura_call_tail -- --nocapture`
