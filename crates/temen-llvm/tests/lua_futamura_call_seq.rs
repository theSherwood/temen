...
//!
//! The fix needs **no engine change**: [`temen_peval::LuaSite::pins`] is a generic list of
...
//! `ci`, so a single [`temen_peval::PoscallModel::selective`] entry covers them.
//!
...
//!
//! Run: `cargo test -p temen-llvm --test lua_futamura_call_seq -- --nocapture`
