...
//! (`POSIX.md` / `STAGE1.md` slice 4). A C guest translated by `temen-llvm` resolves the personality by
...
fn instance() -> temen_run::Instance {
    ...
    let t = temen_llvm::translate_ll_path(bc).expect("translate posix probe");
