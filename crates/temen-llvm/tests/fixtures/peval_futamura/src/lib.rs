...
//!   1. builds a tiny **accumulator-machine interpreter** in temen-IR — `interp(a, b)` loops over a
...
//!   3. encodes the residual with `temen-encode` and submits it to the §22 `Jit` capability
//!      (`__vm_jit_compile`);
...
use temen_peval::{SpecArg, SpecConfig};
...
pub extern "C" fn main(argc: i32, argv: *const *const u8) -> i32 {
    ...
    let residual = match temen_peval::specialize_with_config(
        &m,
        0,
