...
//!
//! `savedpc` is at a fixed, renameable window address here (authored in temen-IR) to control its layout;
...
//!
//! Run: `cargo test -p temen-peval --test savedpc_resume -- --nocapture`
