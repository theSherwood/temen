...
use temen_wasm_jit::{analyze_from, compile_jit, DriveMode, Shape};
...
fn jit_run(m: &temen_ir::Module, entry: u32, arg: i64) -> i64 {
...
fn oracle(m: &temen_ir::Module, entry: u32, arg: i64) -> i64 {
...
fn treewalk_run(m: &temen_ir::Module, entry: u32, arg: i64, fuel: &mut u64) -> Option<i64> {
    match temen_interp::run(m, entry, &[temen_interp::Value::I64(arg)], fuel) {
