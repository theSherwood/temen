...
use temen_wasm_jit::compile_module_reactor_capped;
...
fn run(m: &temen_ir::Module, wasm: &[u8], arg: i64) -> i64 {
                    ...
                    callee
                        ...
                        .map(|t| {
                            ...
                            match t {
                                ...
                                temen_ir::ValType::I64 => Value::I64(raw as i64),
                                temen_ir::ValType::F32 => Value::F32(f32::from_bits(raw as u32)),
                                temen_ir::ValType::F64 => Value::F64(f64::from_bits(raw)),
