...
//! `temen`-crate record differentials, which run through temen-run's `Backend::Bytecode` — a path
...
//!   demand paging (`compile_module_for`'s veto — the bytecode twin of temen-run's
