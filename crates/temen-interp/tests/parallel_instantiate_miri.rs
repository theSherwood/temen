...
//! **parallel** driver. The differential test in `temen/tests/bytecode_parallel_instantiate.rs` proves
...
//!
//! Run: `cargo +nightly miri test -p temen-interp --test parallel_instantiate_miri`
...
fn run_parallel_mod() -> Result<Vec<Value>, temen_interp::Trap> {
