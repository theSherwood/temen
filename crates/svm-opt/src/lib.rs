...
/// [`svm_ir::Inst::for_each_operand_mut`] (which owns the exhaustive, wildcard-free operand
...
pub fn map_operands(inst: &mut Inst, f: &mut impl FnMut(ValIdx) -> ValIdx) {
    // Adapter over the single source of truth in svm-ir (#913): the exhaustive operand
