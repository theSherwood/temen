...
Nothing in the source is TEMEN-specific; the growth happens entirely inside the shipped `malloc`.

```sh
cargo run -p temen-run -- crates/temen-run/demos/heapgrow/heapgrow.c
```
