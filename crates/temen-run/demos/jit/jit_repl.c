...
// standalone `cargo run` program like `jit_demo.c`: it is driven by the embedder's `temen_run::JitSession`,
...
//
// Each prompt: build serialized Temen IR for the unit `(a, b) -> a*b + 10`, `__vm_jit_compile` it (a
