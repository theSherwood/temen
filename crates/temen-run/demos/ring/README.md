...
- **guest** (`-DTEMEN_GUEST`): `FS_MAP_REGION` mints a file-backed `SharedRegion`; the guest maps it
...
Driven by `demo_ring_buffer_magic_mapping_vs_native` in `crates/temen-llvm/tests/translate.rs`.
