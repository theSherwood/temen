...
//! scripted table entry, or (later) a child temen domain — is the wirer's choice, invisible to
...
/// The **child-domain** backend (EXEC.md's third row): a spawn is a fresh temen domain — its own
