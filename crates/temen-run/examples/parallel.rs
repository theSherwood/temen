//! **Parallel scaling — many isolated guests at once.** The Temen's reason for being is hosting many
...
//!
//! Run: cargo run -p temen-run --release --example parallel
...
fn jit_compile(m: &Module) -> temen_jit::CompiledModule {
    temen_jit::CompiledModule::compile(
        m,
        0,
