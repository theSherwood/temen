//! §12 wasm threads — **spawn** (slice 2): the wasi-threads ABI maps onto Temen's native
...
//!
//! These are genuine multi-threaded runs: the interpreter drives its M:N executor (`temen_interp::run`),
