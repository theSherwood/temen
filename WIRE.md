...
|----------|------------|-------------|-----------------|
| `0x0000` | `module`   | implemented | a runnable module — `temen-encode` `encode_module`/`decode_module`; today `version` = 13 (v13: the data-image funcref slots `link` records, #1830; v12: thread-local templates in the object dialect; v11: the memory descriptor carries the module-declared durable shadow arena) |
